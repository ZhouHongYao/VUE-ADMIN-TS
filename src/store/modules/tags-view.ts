...
class TagsView extends VuexModule implements ITagsViewState {
    ...
    @Mutation
    public ADD_VISITED_VIEW(view: ITagView) {
    ...
    @Mutation
    public ADD_CACHED_VIEW(view: ITagView) {
    ...
    @Mutation
    public DEL_VISITED_VIEW(view: ITagView) {
    ...
    @Mutation
    public DEL_CACHED_VIEW(view: ITagView) {
        const index = this.cachedViews.indexOf(view.name)
        if (index > -1) { this.cachedViews.splice(index, 1) }
    }

    @Mutation
    public DEL_OTHERS_VISITED_VIEWS(view: ITagView) {
    ...
    @Mutation
    public DEL_OTHERS_CACHED_VIEWS(view: ITagView) {
        const index = this.cachedViews.indexOf(view.name)
        if (index > -1) {
    ...
    @Mutation
    public UPDATE_VISITED_VIEW(view: ITagView) {
